...
> 1134 - 1158
> 1332 - 1353
Al seguente codice sono state apportate modifiche per renderlo piú funzionale, in modo che si veirifichino meno collisoni con l'intera mano
a volte gli oggetti compenetravano con la mano, lo fatto tutt'ora ma dopo cadono
*/
...
namespace Leap.Unity.Interaction
{
    ...
    public class InteractionBehaviour : MonoBehaviour, IInteractionBehaviour
    {
        ...
        //The Brik company
        /// <summary>
        ///Ottiene la distanza dal punto di passaggio del mouse principale il cui controller sta principalmente passando il mouse su questo
        /// oggetto. Ad esempio, se il controller in bilico principale è una mano Leap, questo restituirà il
        /// distanza dal polpastrello più vicino a questo oggetto.
        /// Se questo oggetto non è l'hover principale di alcun controller di interazione, restituisce infinito positivo.
        /// </summary>
        ...
        /// <summary>
        /// Cancella lo stato di rilevamento del passaggio del mouse per questo oggetto su tutti gli oggetti attualmente in bilico
        /// controllori. Il nuovo stato al passaggio del mouse inizierà di nuovo sul frame fisso successivo se il
        /// se le condizioni appropriate per l'hover sono ancora soddisfatte.
        /// Opzionalmnete cancella lo stato di rilevamento del passaggio del mouse per i controller
        /// ignorando il passaggio del mouse per questo oggetto di interazione a causa del ignoreHoverMode.
        /// </summary>
        ...
        /// <summary>
        /// Cancella il tracciamento dei contatti per questo oggetto su tutti i controller attualmente in contatto.
        /// Se l'oggetto sta ancora contattando i controller e questi sono opportunamente abilitati,
        /// il contatto ricomincerà al prossimo frame fisso.
        /// </summary>
